...
public class NoteBookWindow extends Application {
	...
	private HBox addHBox() {
		...
		buttonSearch.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				ObservableList<String> combox3 = FXCollections.observableArrayList(titleList);
		...
		buttonAddFolder.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				if (result.isPresent()) {
					...
					//If the notebook already has a folder with the input name
					if (noteBook.getFolders().contains(new Folder(name))) {
						Alert alert = new Alert(Alert.AlertType.WARNING);
						alert.setTitle("Warning");
		...
		buttonAddNote.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				if (result.isPresent()) {
					...
					if (!noteBook.createTextNote(currentFolder, name)) {
						Alert alert = new Alert(Alert.AlertType.WARNING);
	                    alert.setTitle("Warning");
	...
	private GridPane addGridPane() {
		...
		Button buttonDel = new Button("Delete Note");
		...
		HBox hbox = new HBox();
		hbox.getChildren().addAll(saveView,buttonSaveNote,deleteView,buttonDel);
		grid.add(hbox, 0, 0);
	...
	private void loadNoteBook() {
		...
		nb.createTextNote("Books", "The Throwback Special: A Novel",
				"Here is the absorbing story of twenty-two men who gather every fall to painstakingly reenact what ESPN called “the most shocking play in NFL history and the Washington Redskins dubbed the hrowback Special: the November 1985 play in which the Redskins Joe Theismann had his leg horribly broken by Lawrence Taylor of the New York Giants live on Monday Night Football. With wit and great empathy, Chris Bachelder introduces us to Charles, a psychologist whose expertise is in high demand; George, a garrulous public librarian; Fat Michael, envied and despised by the others for being exquisitely fit; Jeff, a recently divorced man who has become a theorist of marriage; and many more. Over the course of a weekend, the men reveal their secret hopes, fears, and passions as they choose roles, spend a long night of the soul preparing for the play, and finally enact their bizarre ritual for what may be the last time. Along the way, mishaps, misunderstandings, and grievances pile up, and the comforting traditions holding the group together threaten to give way. The Throwback Special is a moving and comic tale filled with pitch-perfect observations about manhood, marriage, middle age, and the rituals we all enact as part of being alive.");
		nb.createTextNote("Books", "Another Brooklyn: A Novel",
				"The acclaimed New York Times bestselling and National Book Awardinning author of Brown Girl Dreaming delivers her first adult novel in twenty years. Running into a long-ago friend sets memory from the 1970s in motion for August, transporting her to a time and a place where friendship was everything—until it wasn’t. For August and her girls, sharing confidences as they ambled through neighborhood streets, Brooklyn was a place where they believed that they were beautiful, talented, brilliant—a part of a future that belonged to them. But beneath the hopeful veneer, there was another Brooklyn, a dangerous place where grown men reached for innocent girls in dark hallways, where ghosts haunted the night, where mothers disappeared. A world where madness was just a sunset away and fathers found hope in religion. Like Louise Meriwether’s Daddy Was a Number Runner and Dorothy Allison’s Bastard Out of Carolina, Jacqueline Woodson’s Another Brooklyn heartbreakingly illuminates the formative time when childhood gives way to adulthood—the promise and peril of growing up—and exquisitely renders a powerful, indelible, and fleeting friendship that united four young lives.");
